...
import { bounceOnEnterAnimation, bounceOnEnterAnimation2, checkButtonTrigger, highlightedStateTrigger, showStateTrigger } from '../animations';

@Component({
  selector: 'app-lista-tarefas',
  templateUrl: './lista-tarefas.component.html',
  styleUrls: ['./lista-tarefas.component.css'],
  animations: [highlightedStateTrigger, showStateTrigger, bounceOnEnterAnimation(), bounceOnEnterAnimation2(), checkButtonTrigger]
})
